...
def grype_db():
    http_file(
        name = "cve_database",
        sha256 = "f8d9b30cbb7022a4d8361399d04be18eb999529632d33ffe1525168860a1e75f",
        urls = [
            "https://toolbox-data.anchore.io/grype/databases/vulnerability-db_v3_2022-02-14T08:19:30Z.tar.gz",
        ],
    )
