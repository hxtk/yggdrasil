...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Dcmn+juq2FPNLcIaRPoQr1Hsj0ItTgn7r9j40u2gTLU=",
        version = "v0.6.0",
    )
    go_repository(
        name = "com_github_authzed_grpcutil",
        importpath = "github.com/authzed/grpcutil",
        sum = "h1:HfDkRg7B2Ss2xhSD23535S29cCFFR+N3lt+MYUbc/Aw=",
        version = "v0.0.0-20210913124023-cad23ae5a9e8",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_keys_pub_go_libfido2",
        importpath = "github.com/keys-pub/go-libfido2",
        sum = "h1:YJVK9iMOMlfRZrEzZtnJBRNO+jYB+/sfNtO4ruV7BXI=",
        version = "v1.5.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:F2pYKdbHUmcK08dyJKm2jHAngNOgVjTDP8wH4Pa3w0Q=",
        version = "v0.4.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:5s5fUTV6/s5h5B8Zp26x7Yabfl4OQTt/qILwhuOrN6M=",
        version = "v0.0.0-20220728233804-1ec054bb67ca",
    )
    ...
    go_repository(
        ...
        sum = "h1:UreQrH7DbFXSi9ZFox6FNT3WBooWmdANpU+IfkT1T4I=",
        version = "v0.0.0-20220728211354-c7608f3a8462",
    )
    go_repository(
...
def grype_db():
    ...
    http_file(
        ...
        sha256 = "a1db013c16290a7bb8f306e730673d6e56e0660b7b1f1e7035e6e54402c62d25",
        urls = ["https://toolbox-data.anchore.io/grype/databases/vulnerability-db_v5_2023-11-17T01:27:17Z_bfa8f795c2fbd474e246.tar.gz"],
    )
